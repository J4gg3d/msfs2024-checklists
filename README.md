...
1. Download from [dotnet.microsoft.com/download/dotnet/7.0](https://dotnet.microsoft.com/download/dotnet/7.0)
2. Choose **.NET Runtime 7.0** (not SDK, unless you want to compile yourself)
